...
|                                                                                    |                                                           |                  |
| [The AEther GR Derivation](https://github.com/AngryOwlAI/The-AEther-GR-Derivation) | This repository is the active working repository <br> for The Æther-Flow Interpretation of Relativity, a human-led, <br> AI-assisted theoretical physics research program <br> built on the Æther / Æther-flow ontology. <br> The repository  goal is to derive or General Relativity <br> from The Æther-Flow Interpretation of Relativity theory/concept.    | In-Progress      |
...
[![Jupyter](https://img.shields.io/badge/Jupyter-FA0F00?style=flat&logo=jupyter&logoColor=white)](https://jupyter.org/)
